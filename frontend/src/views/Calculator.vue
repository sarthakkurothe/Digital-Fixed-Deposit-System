  ...
  <div class="p-6 space-y-6 bg-gray-50 min-h-screen">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
      ...
      <div class="space-y-6">
        <div class="bg-white rounded-xl shadow-xl p-6 flex flex-col">
          ...
          <div class="mb-4">
            ...
            <SchemeDropdown v-model="selectedScheme" :schemes="schemesToShow" placeholder="Select Scheme" />
      ...
      <div class="space-y-6">
        ...
        <div v-if="hasCompoundInterest" class="bg-white rounded-xl shadow-xl p-6 flex flex-col max-h-[400px] overflow-y-auto">
          <div class="flex items-center mb-4">
    ...
    <div class="bg-white rounded-xl shadow-xl p-6 text-gray-700 leading-relaxed">
      ...
      <p class="mt-2">There are two types of fixed deposits — <strong>Simple Interest FD</strong> and <strong>Compound Interest FD</strong>...</p>
      ...
      <p class="text-sm mt-2">Where: P = Principal, r = Rate, n = compounding per year, t = Years</p>
    </div>
  </div>
</template>
...
export default {
  ...
  computed: {
    ...
    bestMaturityAmount() {
      return this.hasCompoundInterest ? this.calculationResults.compound.maturityAmount : this.calculationResults.simple.maturityAmount;
    },
    bestMaturityInterest() {
      return this.hasCompoundInterest ? this.calculationResults.compound.interest : this.calculationResults.simple.interest;
    },
    simpleInterest() {
