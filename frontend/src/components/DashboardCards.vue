<template>
  ...
  <div
    class="bg-gradient-to-r from-green-50 to-green-100 p-6 rounded-lg border border-green-200 hover:shadow-sm transition-shadow"
  >
    <div class="flex items-center justify-between mb-4">
...
export default {
  ...
  computed: {
    ...
    totalAccuredInterest() {
      return this.getSummary.interestEarned
        ? parseFloat(this.getSummary.interestEarned).toLocaleString('en-IN')
        : '0';
